...
class Distribuicao_federal():
    ...
    def creat_html(self):
        ...
        payload='Tipo=CIVEL&TipoDeDocumento=CPF&Documento=403.154.468-54&Nome=Wesley Silva Cabral de Oliveira&NomeSocial=&Abrangencia=SJSP&g-recaptcha-response={}&__RequestVerificationToken={}'.format(self._response,self._token)
        headers = {
        'authority': 'web.trf3.jus.br',
